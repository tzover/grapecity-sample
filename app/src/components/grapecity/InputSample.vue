      ...
      <tbody>
        <tr>
          ...
          <td>
            ...
            <wj-input-number format="n2" :min="0" :max="10" :step="0.5" v-model="theValue" />
            <p>
        ...
        <tr>
          ...
          <td>
            ...
            <p>選択されたグリフ: <span v-bind:class="'wj-glyph-' + selectedGlyph"></span></p>
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td>
            <wj-input-color :value="color" :value-changed="colorChanged" />
            <p>色: {{ color }}</p>
          </td>
        </tr>
        <tr>
          ...
          <td>
            ...
            <wj-popup :initialized="popupInitialized" show-trigger="Click" hide-trigger="None">
              <h3 class="popover-title">タイトル</h3>

...
const _allCountries = [
    'アメリカ', '日本', '中国', 'ドイツ', 'イギリス', 'アフガニスタン', 'アルバニア', 'アルジェリア', 'アメリカ領サモア', 'アンドラ', 'アンゴラ', 'アングィラ', 'アンティグア', 'アルゼンチン', 'アルメニア', 'アルバ', 'オーストラリア', 'オーストリア', 'アゼルバイジャン', 'バハマ', 'バーレーン', 'バングラデシュ', 'バルバドス', 'ベラルーシ', 'ベルギー', 'ベリーズ', 'ベニン', 'バミューダ', 'ブータン', 'ボリビア', 'ボネール島', 'ボスニア', 'ボツワナ', 'ブラジル', 'ブルネイ', 'ブルガリア', 'ブルキナファソ', 'ブルンジ', 'カンボジア', 'カメルーン', 'カナダ', 'カナリア諸島', 'カーボベルデ', 'ケイマン諸島', '中央アフリカ共和国', 'チャド', 'チャネル諸島', 'チリ', 'クリスマス島', 'ココス島', 'コロンビア', 'コモロ', 'コンゴ', 'クック諸島', 'コスタリカ', 'コートジボワール', 'クロアチア', 'キューバ', 'キュラソー', 'キプロス', 'チェコ共和国', 'デンマーク', 'ジブチ', 'ドミニカ', 'ドミニカ共和国', '東チモール', 'エクアドル', 'エジプト', 'エルサルバドル', '赤道ギニア', 'エリトリア', 'エストニア', 'エチオピア', 'フォークランド諸島', 'フェロー諸島', 'フィジー', 'フィンランド', 'フランス', '仏領ギアナ', 'フランス領ポリネシア', 'フランス南部テル', 'ガボン', 'ガンビア', 'ジョージア', 'ガーナ', 'ジブラルタル', 'ギリシャ', 'グリーンランド', 'グレナダ', 'グアドループ島', 'グアム', 'グアテマラ', 'ギニア', 'ガイアナ', 'ハイチ', 'ホンジュラス', '香港', 'ハンガリー', 'アイスランド', 'インド', 'インドネシア', 'イラン', 'イラク', 'アイルランド', 'マン島', 'イスラエル', 'イタリア', 'ジャマイカ', 'ヨルダン', 'カザフスタン', 'ケニア', 'キリバス', '北朝鮮', '韓国', 'クウェート', 'キルギスタン', 'ラオス', 'ラトビア', 'レバノン', 'レソト', 'リベリア', 'リビア', 'リヒテンシュタイン', 'リトアニア', 'ルクセンブルク', 'マカオ', 'マケドニア', 'マダガスカル', 'マレーシア', 'マラウイ', 'モルディブ', 'マリ', 'マルタ', 'マーシャル諸島', 'マルティニーク島', 'モーリタニア', 'モーリシャス', 'マヨット島', 'メキシコ', 'ミッドウェー諸島', 'モルドバ', 'モナコ', 'モンゴル', 'モントセラト', 'モロッコ', 'モザンビーク', 'ミャンマー', 'ナンビア', 'ナウル', 'ネパール', 'オランダ領アンティル', 'オランダ', 'ネビス島', 'ニューカレドニア', 'ニュージーランド', 'ニカラグア', 'ニジェール', 'ナイジェリア', 'ニウエ', 'ノーフォーク島', 'ノルウェー', 'オマーン', 'パキスタン', 'パラオ島', 'パレスチナ', 'パナマ', 'パプアニューギニア', 'パラグアイ', 'ペルー', 'フィリピン', 'ピトケアン島', 'ポーランド', 'ポルトガル', 'プエルトリコ', 'カタール', 'モンテネグロ共和国', 'セルビア共和国', 'レユニオン', 'ルーマニア', 'ロシア', 'ルワンダ', 'サンバルテルミ', 'セントユーステーシャス', 'セントヘレナ', 'セントキッツ・ネイビス', 'セントルシア', 'サン・マルタン島', 'サイパン島', 'サモア', 'サン・マリノ', 'サウジアラビア', 'スコットランド', 'セネガル', 'セルビア', 'セイシェル', 'シエラレオネ', 'シンガポール', 'スロバキア', 'スロベニア', 'ソロモン諸島', 'ソマリア', '南アフリカ', 'スペイン', 'スリランカ', 'スーダン', 'スリナム', 'スワジランド', 'スウェーデン', 'スイス', 'シリア', 'タヒチ島', '台湾', 'タジキスタン', 'タンザニア', 'タイ', 'トーゴ', 'トケラウ諸島', 'トンガ', 'トリニダード・トバゴ', 'チュニジア', 'トルコ', 'トルクメニスタン', 'タークス・カイコス諸島', 'ツバル', 'ウガンダ', 'ウクライナ', 'アラブ首長国連邦', 'イギリス', 'ウルグアイ', 'ウズベキスタン', 'バヌアツ', 'バチカン市国', 'ベネズエラ', 'ベトナム', 'バージン諸島（イギリス）', 'バージン諸島（米国）', 'ウェーク島', 'イエメン', 'ザイール', 'ザンビア', 'ジンバブエ'
];
...
export const DataService = {
    ...
    getSimpleDataSet() {
        var dtOct = new Date(2015, 9, 1),
            ...
            data = [
                { product: 'Wijmo', country: 'アメリカ', sales: 10, downloads: 100, date: dtOct, active: true },
                { product: 'Wijmo', country: '日本', sales: 10, downloads: 100, date: dtOct, active: false },
                { product: 'SpreadJS', country: 'アメリカ', sales: 10, downloads: 100, date: dtDec, active: true },
                { product: 'SpreadJS', country: '日本', sales: 10, downloads: 100, date: dtDec, active: false }
            ];
    ...
    getMultiRowData() {
        var orders = [],
            today = new Date(),
            customers = [],
            firstNames = '佐藤,鈴木,高橋,田中,伊藤,山本,渡辺,中村,小林,加藤,吉田,山田,佐々木,山口,松本,井上,木村,斎藤,林,清水,山崎,阿部,森,池田,橋本,山下,石川,中島,前田,藤田'.split(','),
            lastNames = '浩,誠,健一,大輔,達也,翔太,浩一,哲也,剛,大介,健太,拓也,豊,修,和彦,学,直樹,健太郎,浩二,徹,隆,亮,翔,恵子,久美子,由美子,明美,直美,陽子,智子,絵美,恵,裕子,愛,真由美,由美,麻衣,美穂,愛美,彩'.split(','),
            states = '日本'.split(','),
            shippers = [
        ...
        for (let i = 0; i < 50; i++) {
            ...
            customers.push({
                id: i,
                name: first + ' ' + last,
                address: `${String.fromCharCode(DataService.randBetween(65, 90))}市${String.fromCharCode(DataService.randBetween(65, 90))}町${DataService.randBetween(1, 10)}-${DataService.randBetween(1, 10)}-${DataService.randBetween(1, 10)}`,
